...
namespace WebApp.Models.PrescriptionModels
{
    public class PrescriptionViewModel
    {
        ...
        [Display(Name = "Lekarz")]
        public string DoctorFullName { get => $"{Doctor.FirstName} {Doctor.LastName}"; }

        [Display(Name = "ID Aptekarza")]
        public int ApothecaryId { get; set; }

        [Display(Name = "Aptekarz")]
        public string ApothecaryFullName { get => $"{Apothecary.FirstName} {Apothecary.LastName}"; }

        [Display(Name = "Data wypisania recepty")]
        [DisplayFormat(DataFormatString = "{0:dd MMMM yyyy}")]
        public DateTime PrescriptionDate { get; set; }

        [Display(Name = "Data wykupienia recepty")]
        [DisplayFormat(DataFormatString = "{0:dd MMMM yyyy}")]
